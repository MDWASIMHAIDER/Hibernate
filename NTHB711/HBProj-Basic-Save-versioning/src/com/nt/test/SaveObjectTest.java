...
public class SaveObjectTest {
	...
	public static void main(String[] args) {
		...
		// factory=cfg.buildSessionFactory(regis);
		 ...
		 emp=new Employee();
		 emp.setEno(1013); emp.setEname("Mr haider");
		 emp.setDesg("sr-dev"); emp.setSalary(5500);
		 try {
			 //begin Transaction
			 tx=ses.beginTransaction();
				 //save object
			ses.saveOrUpdate(emp);//where obj recieves the identity value like 1016 setEno() serialize
