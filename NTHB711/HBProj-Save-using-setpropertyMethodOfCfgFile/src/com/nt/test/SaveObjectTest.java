...
public class SaveObjectTest {
	...
	public static void main(String[] args) {
		...
		//BootStrap Hibernate 
		 cfg=new Configuration();
		 cfg.setProperty("hibernate.conncetion.driver_class", "oracle.jdbc.driver.OracleDriver");
		 cfg.setProperty("hiernate.connection.url", "jdbc:oracle:thin:@localhost:1521:xe");
		 cfg.setProperty("hibernate.conncetion.username", "system");
		 ...
		 cfg.addFile("src/com/nt/confg/Employe.hbm.xml");
		// cfg.addResource("src/com/nt/confg/Employe.hbm.xml");
		...
		// factory=cfg.buildSessionFactory(regis);
		 ...
		 emp=new Employee();
		 emp.setEno(1088); emp.setEname("murli");
		 emp.setDesg("faculty"); emp.setSalary(12500);
		// try {
			 //begin Transaction
